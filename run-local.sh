#
# This script is used to run the Custody Manager API locally, to interact with
...
export DB_NAME=custody-manager
export DB_USER=custody-manager
export DB_PASS=custody-manager
