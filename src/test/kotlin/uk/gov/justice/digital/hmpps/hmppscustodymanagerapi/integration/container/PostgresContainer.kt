package uk.gov.justice.digital.hmpps.hmppscustodymanagerapi.integration.container
...
object PostgresContainer {
  ...
  private fun startPostgresqlIfNotRunning(): PostgreSQLContainer<Nothing>? {
    ...
    return PostgreSQLContainer<Nothing>("postgres:16").apply {
      ...
      withDatabaseName("custody-manager")
      withUsername("custody-manager")
      withPassword("custody-manager")
